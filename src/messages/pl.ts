...
const messages = {
  ...
  AuthHeader: {
    ...
    openProfile: "Profil i ustawienia",
  },
  FluxPromote: {
    ...enMessages.FluxPromote,
    title: "Flux Promote",
    subtitle: "Promuj projekty NeoFlux przez ukierunkowany PR outreach.",
    selectCompany: "Wybierz firmę",
    selectProject: "Wybierz projekt",
    targetAudiences: "Grupy docelowe",
    suggestedKeywords: "Sugerowane słowa kluczowe",
    projectFitScore: "Ocena dopasowania projektu",
    suggestedAngle: "Sugerowany kąt komunikacji",
    whyThisTarget: "Dlaczego ten cel pasuje?",
    generatePrMessage: "Wygeneruj wiadomość PR",
    shortDm: "Krótka wiadomość DM",
    communityComment: "Komentarz do społeczności",
    launchPost: "Post startowy",
    partnerPitch: "Propozycja partnerstwa",
    sellerInvitation: "Zaproszenie sprzedawcy",
    betaTesterInvitation: "Zaproszenie beta testera",
    safetyWarning:
      "Sprawdź każdą wiadomość przed wysłaniem. Szanuj zasady platform, reguły społeczności i opt-out.",
    createCampaign: "Utwórz kampanię PR",
    campaigns: "Kampanie",
    noCampaigns: "Nie ma jeszcze kampanii Flux Promote.",
    campaignCreated: "Kampania Flux Promote została utworzona.",
    searchTargets: "Szukaj celów PR",
    searchPlaceholder:
      "Przykład: Unity developers posting about AI tooling on GitHub and X",
    searchCta: "Szukaj celów",
    addTarget: "Dodaj cel ręcznie",
    saveTarget: "Zapisz cel",
    targetSaved: "Cel zapisany.",
    targetsSaved: "Zapisano cele: {count}.",
    noTargets: "Nie ma jeszcze celów PR. Uruchom wyszukiwanie albo dodaj cel ręcznie.",
    messageDraftTabs: "Zakładki draftów",
    messageGenerated: "Draft wiadomości PR wygenerowany do ręcznej weryfikacji.",
    working: "Pracuję...",
