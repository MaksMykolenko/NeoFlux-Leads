...
const messages = {
  ...
  FluxPromote: {
    title: "Flux Promote",
    subtitle: "Promote NeoFlux projects with targeted PR outreach.",
    selectCompany: "Select company",
    selectProject: "Select project",
    targetAudiences: "Target audiences",
    suggestedKeywords: "Suggested search keywords",
    projectFitScore: "Project Fit Score",
    suggestedAngle: "Suggested PR angle",
    whyThisTarget: "Why this target?",
    generatePrMessage: "Generate PR message",
    shortDm: "Short DM",
    communityComment: "Community comment",
    launchPost: "Launch post",
    partnerPitch: "Partner pitch",
    sellerInvitation: "Seller invitation",
    betaTesterInvitation: "Beta tester invitation",
    safetyWarning:
      "Review every message before sending. Respect platform rules, community guidelines and opt-outs.",
    createCampaign: "Create PR campaign",
    campaigns: "Campaigns",
    noCampaigns: "No Flux Promote campaigns yet.",
    campaignCreated: "Flux Promote campaign created.",
    searchTargets: "Search PR targets",
    searchPlaceholder:
      "Example: Unity developers posting about AI tooling on GitHub and X",
    searchCta: "Search targets",
    addTarget: "Add target manually",
    saveTarget: "Save target",
    targetSaved: "Target saved.",
    targetsSaved: "{count} targets saved.",
    noTargets: "No PR targets yet. Search or add one manually.",
    messageDraftTabs: "Message draft tabs",
    messageGenerated: "PR message draft generated for manual review.",
    working: "Working...",
