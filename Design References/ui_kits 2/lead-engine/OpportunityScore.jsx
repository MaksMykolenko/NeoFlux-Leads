  ...
  return h(Card, null, [
    ...
    h("div", { key: "n", className: "mt-6 flex flex-wrap items-end gap-x-6 gap-y-3" }, [
      h("div", { key: "num", className: "flex items-baseline gap-2" }, [
        ...
        h("span", { key: "d", className: "text-base text-zinc-400 dark:text-zinc-600" }, "/ 100")
      ]),
    ...
    h("div", { key: "bar", className: "mt-6" }, [
      h("div", {
        key: "track",
        className: "h-2 w-full overflow-hidden rounded-full bg-zinc-100 dark:bg-flux-border-strong"
      }, h("div", {
