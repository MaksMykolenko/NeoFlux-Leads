  ...
  return (
    <div className="inline-flex flex-col items-start gap-1">
      <button
        ...
        onClick={onClick}
        disabled={isPending}
        className="inline-flex h-8 items-center gap-1.5 rounded-md border border-gray-200 bg-white px-3 text-xs font-medium text-gray-700 shadow-sm transition hover:border-purple-300 hover:bg-purple-50 hover:text-purple-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 disabled:cursor-progress disabled:opacity-70"
      >
        {isPending ? (
          <Spinner />
        ) : (
